...
public class Seeds {
    ...
    public static void seedData(){
        ...
        Manager manager = new Manager("Mark", "Owen", 40000,department1, 100000 );
        DBHelper.save(manager);
        Engineer engineer1 = new Engineer("Gary", "Barlow", 29000, department1);
        DBHelper.save(engineer1);
        Engineer engineer2 = new Engineer("Robbie", "Williams", 27000, department1);
